...
<head>
    ...
    <title><?= $title ?? 'NSS APPARELS | Quality Clothing' ?></title>
...
<body class="bg-white dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 transition-colors duration-300"
    x-data="{ 
        mobileMenu: false,
        scrolled: false,
    ...
    <?= $this->include('partials/frontend/navbar') ?>
